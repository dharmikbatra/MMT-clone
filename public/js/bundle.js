    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Data Updated"));
          }
          _context.next = 11;
          break;
        case 8:
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            tourId = e.target.dataset.tourId; // data-tour-id banaya hai html mein, it converts to dataset.tourId
            _context4.next = 4;
